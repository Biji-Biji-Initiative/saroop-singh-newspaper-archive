...
// Bundle the Markdown catalogue into the Worker at build time. Hosted Workers
// do not have a writable/readable project filesystem at request time.
const articleFiles = import.meta.glob('../content/articles/published/*.md', {
  eager: true,
  query: '?raw',
  import: 'default',
